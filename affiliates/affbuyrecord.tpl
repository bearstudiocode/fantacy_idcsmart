				...
				<div class="col-sm-6">
					<div class="search-box">
						<div class="position-relative">
							<input type="text" class="form-control" id="affbuyrecordSearchInp" placeholder="按关键字搜索">
		...
		<table class="table tablelist">
			...
			<thead class="bg-light">
				<tr>
					...
					<th class="pointer" prop="type">{$Lang.type}
						<span class="text-black-50 d-inline-flex flex-column justify-content-center ml-1 offset-3">
							<i class="bx bx-caret-up"></i>
							<i class="bx bx-caret-down"></i>
						</span>
					...
					<th class="pointer" prop="aff_sure_time">{$Lang.confirmation_time}
						<span class="text-black-50 d-inline-flex flex-column justify-content-center ml-1 offset-3">
							<i class="bx bx-caret-up"></i>
							<i class="bx bx-caret-down"></i>
						</span>
