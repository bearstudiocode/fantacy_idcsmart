...
<div class="row">
	<div class="col-sm-4">
		<div class="card bg-promote" style="border-radius:30px">
			<div class="card-body">
          ...
          >
                ...
                refresh)" class="btn bg-white px-3" id="withdrawNow"
                 ...
                 {if $Affiliates.affiliate_withdraw>$Affiliates.data.balance}disabled{/if} style="color: #626ed4;">{$Lang.immediate_withdrawal}</button>
	...
	<div class="col-sm-8">
		<div class="card" style="border-radius:20px">
			<div class="card-body">
				<h4 class="fs-16 fw-400">{$Lang.offer_link}</h4>
