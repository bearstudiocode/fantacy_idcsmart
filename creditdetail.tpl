...
<script src="{$Setting.web_url}/themes/clientarea/default/assets/libs/html2canvas/html2canvas.min.js?v={$Ver}"></script>
<script src="{$Setting.web_url}/themes/clientarea/default/assets/libs/jspdf/jspdf.umd.min.js?v={$Ver}"></script>
