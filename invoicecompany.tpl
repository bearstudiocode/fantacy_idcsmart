								...
								<div class="custom-control custom-radio">
									<span class="mr-5">
										<input type="radio" id="personRadio" name="issue_type" value="person" class="custom-control-input"
											...
											class="custom-control-label" for="personRadio">个人</label>
									</span>
									<span>
				...
				<table class="table tablelist">
					...
					<thead class="bg-light">
						<tr>
							...
							<th class="pointer" prop="issue_type">
							...
							<th class="pointer" prop="voucher_type">
...
<script>
	function delTitle(id) {
		...
		$.ajax({
			type: "DELETE",
			url: '{$Setting.web_url}' + '/voucher/voucherinfo',
			data: {
				id
			},
