	...
	<div class="card-body">
		<div class="table-container">
			...
			<div class="table-responsive">
				<table id="datatable-buttons" class="table tablelist">
					<colgroup>
						<col width="50px">
						<col>
						<col>
						...
						<tr>
							...
							<td>
								<div>
									...
									{elseif $list.billingcycle == 'hour'}{$list.pay_type.pay_hour_cycle}{$Lang.hour}{$Lang.hour}
							...
							<td>
								{if $list.os_url}
								{if $list.svg}
								<img width="14" height="14" src="{$Setting.web_url}/upload/common/system/{$list.svg}.svg" alt="">
								{else}
								<img width="14" height="14" src="{$Setting.web_url}/upload/common/system/{$list.os_url|getOsSvg}.svg"
									alt="">
								{/if}
								{$list.os_url}
								{else}
			...
			<div class="table-footer">
				<div class="table-tools">
					<button disabled class="btn btn-outline-primary w-xs" id="readBtn">{$Lang.renew}</button>
				<div class="btn-group  dropup">
			
						<button class="btn btn-secondary dropdown-toggle not-allowed" id="bulkOperation" type="button"
...
<script>
	...
	$('#modifyNotesSubmit').on('click', function () {
		$.ajax({
			type: "POST",
			url: '{$Setting.web_url}' + '/host/remark',
			data: {
				id: rowId,
				remark: $('#notesInp').val()
			},
...
<script>
  ...
  // });
       ...
       <!-- Required datatable js -->
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net/js/jquery.dataTables.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-bs4/js/dataTables.bootstrap4.min.js"></script>
        <!-- Buttons examples -->
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-buttons/js/dataTables.buttons.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-buttons-bs4/js/buttons.bootstrap4.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/jszip/jszip.min.js"></script>
      
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-buttons/js/buttons.html5.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-buttons/js/buttons.print.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-buttons/js/buttons.colVis.min.js"></script>
        <!-- Responsive examples -->
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-responsive/js/dataTables.responsive.min.js"></script>
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/datatables.net-responsive-bs4/js/responsive.bootstrap4.min.js"></script>

        <!-- Datatable init js -->
        <script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/js/pages/datatables.init.js"></script> 