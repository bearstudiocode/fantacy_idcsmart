            ...
            <span>
              {if $Detail.host_data.dedicatedip}
                {if $Detail.host_data.assignedips}
                  <span class="tuxian" id="copyIPContent">{$Detail.host_data.dedicatedip}</span>
        ...
        <div class="card-body">
          ...
          <div class="row">
            <div class="col-12 mb-2">
              <div class="bg-light card-body bg-purple" style="border-radius:20px">
          ...
          <div class="row">
            ...
            <div class="col-md-6 mb-2">
              ...
              <div class="bg-light card-body py-2 bg-gray" style="border-radius:20px">
            ...
            <div class="col-12 mb-2">
              ...
              <div class="bg-light card-body bg-gray"  style="border-radius:20px">
              ...
              <div class="bg-light card-body bg-gray" style="border-radius:20px">
                ...
                <section class="d-flex align-items-center">
                  ...
                  <h4 class="mb-0 mr-2">
                    ...
                    {$Detail.host_data.firstpaymentamount_desc?$Detail.host_data.firstpaymentamount_desc:'-'}</h4>

                  <span class="badge

                      {$Detail.host_data.format_nextduedate.class}"></span>
