            ...
            <div class="col-lg-5 mb-1">
              <div class="p-5 bg-primary rounded text-white d-flex flex-column
                ...
                <span class="badge badge-pill py-1 status-{$Detail.host_data.domainstatus|strtolower}
                  mb-3">{$Detail.host_data.domainstatus_desc}</span>
              </div>
            </div>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          ...
                          <span
                            class="ml-2 badge {$Detail.host_data.format_nextduedate.class}">{$Detail.host_data.format_nextduedate.msg}</span>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <td>{$Detail.host_data.format_nextduedate.msg}</td>
                        {else}
