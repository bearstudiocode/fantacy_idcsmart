            ...
            <div class="d-flex justify-content-end flex-shrink-1 flex-grow-1">
              ...
              <div class="btn-group ml-2 mr-2 mt-2">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')" data-func="on"
                    data-des="{$Lang.confirm_turn_on}">{$Lang.batch_operation}</a>
                  {/if}
                  {if $Detail.dcim.auth.off == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')" data-func="off"
                    data-des="{$Lang.confirm_turn_off}">{$Lang.shut_down}</a>
                  {/if}
                  {if $Detail.dcim.auth.reboot == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')" data-func="reboot"
                    data-des="{$Lang.confirm_turn_restart}">{$Lang.restart}</a>
                  {/if}
                  {if $Detail.dcim.auth.bmc == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')" data-func="bmc"
                    data-des="{$Lang.confirm_turn_mbc}">{$Lang.reset_bmc}</a>
                  {/if}

                  {if $Detail.dcim.auth.rescue == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')"
              ...
              <div class="btn-group ml-2 mr-2 mt-2">
                ...
                <div class="dropdown-menu">
                  ...
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')" data-func="kvm">kvm</a>
                  {/if}
                  {if $Detail.dcim.auth.ikvm == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}')"
                    data-func="ikvm">ikvm</a>
                  {/if}
                  {if $Detail.dcim.auth.novnc == 'on'}
                  <a class="dropdown-item dcim_service_module_button" href="javascript:void(0);" onclick="dcim_service_module_button($(this), '{$Think.get.id}');" data-func="vnc">vnc</a>
                  {/if}
                </div>
              </div>
      ...
      <div class="card">
        <div class="card-body ">
          <ul class="nav nav-tabs nav-tabs-custom" role="tablist">
            {if $Detail.host_data.domainstatus == 'Active' && $Detail.host_data.dcimid && $Detail.dcim.auth.traffic == 'on'}
