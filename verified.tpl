...
<!-- 图片上传 -->
<script src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/dropzone/min/dropzone.min.js?v={$Ver}"></script>
<!--二维码-->
<script type="text/javascript" src="{$Setting.web_url}/themes/clientarea/fantacy/assets/libs/qrcode/jquery.qrcode.min.js?v={$Ver}"></script>
<!-- 增加支付 -->
<script>
	var _url = '{$Setting.web_url}';
</script>
<script src="{$Setting.web_url}/themes/clientarea/default/assets/js/billing.js?v={$Ver}"></script>
...
{if $Verified.certifi_message.status == '4' && $Verified.plugin != 'artificial'}
	...
	<div class="card" style="border-radius:20px">
		<div class="card-body text-center">
			<h1 class="pt-4 font-weight-bold"><img src="/themes/clientarea/fantacy/assets/images/Certification_pass.png" alt=""> 申请资料已提交！</h1>
				...
				<div class="row">
					<form class="needs-validation w-100" novalidate method="post" enctype="multipart/form-data">
								...
								{foreach $certifi_select_val.custom_fields as $k1=>$custom_fields}
									{if $custom_fields.type == 'text'}
										<div class="form-group row mb-4 w-100">
											...
											<div class="col-md-6 offset-md-3">
												<input type="text" class="form-control" name="{$custom_fields.field}" value="" placeholder="{$custom_fields.title}" required>
											</div>
										</div>
						...
						{if $Verified.certifi_message.certifi_is_upload == '1'||$Think.get.type == 'other'}
							<div class="form-group row mb-4 w-100" id="idcardImg">
...
<div class="col-lg-4">
									<div class="card text-white bg-primary">
										...
										<img src="{$Setting.web_url}/themes/clientarea/default/assets_custom/img/upload-id-card-fron.png" alt="">
										<img src="{$Setting.web_url}/themes/clientarea/default/assets_custom/img/upload-id-card-back.png" alt="">
...
{elseif $Think.get.action == 'enterprises' && $Think.get.step == 'info'}
	...
	{/if}
	{if $SuccessMsg}
		<script type="text/javascript" src="{$Setting.web_url}/themes/clientarea/default/assets/libs/qrcode/jquery.qrcode.min.js?v={$Ver}"></script>
<script>
	$(function () {
		var url = '{$Url}'
		var type = '{$CertifiPlugin}'
								...
								<div class="col-md-6 offset-md-3">
									<div class="input-group mb-1 attachment-group">
										<div class="custom-file">
											...
											<input type="file" class="custom-file-input" name="attachments[]" id="businessLicenseInput">
										</div>
									</div>
		...
		<div class="container-fluid mt-0">
			<div class="row">
				<div class="mx-auto pb-5 col-sm-9 d-flex flex-column justify-content-center align-items-center">
					<h3 class="mt-4">	<img class="mr-4" style="width:48px;" src="{$Setting.web_url}/themes/clientarea/default/assets_custom/img/Certification_pass.png" alt="">{$Lang.certification_complete}</h3>
          ...
          <h5 class="pt-4 font-weight-bold">会员信息</h5>
						<div class="mt-4 text-center" style="width:230px;">
			...
			<div class="col-md-10 col-sm-12">
				...
				<div class="verified_not_certified">
					<div class="not_certified_title phonehide">
						<i class="far fa-user"></i> {$Lang.not_name_authentication}
					</div>
					
					<div class="not_certified_text">
					<div class="alert alert-primary" role="alert"  style="border-radius:20px">
					...
					<div class="row" style="margin:10px 5px 15px -10px;">
						<div class="col-12 col-md-6">
							<div class="type-item" style="border-radius:20px">
								...
								<a href="verified?action=personal&step=info" class="btn btn-outline-primary">{$Lang.certification_now}</a>
							</div>
						</div>
						...
						<div class="col-12  col-md-6">
							<div class="type-item" style="border-radius:20px">
								...
								<a href="verified?action=enterprises&step=info"
									class="btn btn-outline-primary">{$Lang.certification_now}</a>
							</div>
						</div>
					</div>
				</div>
...
<div class="card ststus-box" style="border-radius:20px">
	<div class="card-body p-5">
		<div class="container-fluid mt-5">
			<div class="row">
				<div class="mx-auto pt-4 pb-5 col-sm-9 border d-flex flex-column justify-content-center align-items-center">
					<img class="mt-5" src="{$Setting.web_url}/themes/clientarea/default/assets_custom/img/Certification_fail.png" alt="">
...
<div class="card ststus-box" style="border-radius:20px">
	<div class="card-body p-5">
		<div class="container-fluid mt-5">
			<div class="row">
				<div class="mx-auto pt-4 pb-5 col-sm-9 border d-flex flex-column justify-content-center align-items-center">
					<img class="mt-5" src="{$Setting.web_url}/themes/clientarea/default/assets_custom/img/Certification_review.png" alt="">
					...
					<div class="mt-5 mb-5">
						...
						<p>{$Lang.certificate_picture}: {if ($Verified.certifi_message.img_one && $Verified.certifi_message.img_two)}{$Lang.uploaded}{else}{$Lang.not_uploaded}{/if}</p>
...
<!-- </div> -->
<script type="text/javascript" src="{$Setting.web_url}/themes/clientarea/fantacy/assets/js/verified.js?v={$Ver}"></script>