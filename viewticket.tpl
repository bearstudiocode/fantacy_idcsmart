...
<link href="{$Setting.web_url}/themes/clientarea/default/assets/libs/bootstrap-rating/bootstrap-rating.css?v={$Ver}"
	rel="stylesheet" />
<div class="row">
	<div class="col-12">
		<div class="card mb-3">
			...
			<h4 class="card-title mb-0 p-3">
				...
				<div class="ticket-actions float-sm-right mt-3 mt-sm-0">
					<a href="javascript: getModal('ticket/close', '{$Lang.close_work_order}', '{$Lang.close_the_job}', {tid: {$ViewTicket.ticket.tid}, token: '{$Token}'});"
...
<script src="{$Setting.web_url}/themes/clientarea/default/assets/libs/bootstrap-rating/bootstrap-rating.min.js?v={$Ver}"></script>
<script src="{$Setting.web_url}/themes/clientarea/default/assets/js/rating-init.js?v={$Ver}"></script>
<script>
	...
	function adminScore(rid, type) {
		...
		$.ajax({
			type: "post",
			url: '{$Setting.web_url}' + '/ticket/evaluate',
			data: obj,
